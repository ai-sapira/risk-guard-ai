          ...
          <div className="flex items-center gap-3 w-full">
             ...
             <div className="flex flex-1 items-center justify-between min-w-0">
                <div className="flex flex-col">
                    <span className="text-[13px] font-bold text-slate-900 truncate tracking-tight leading-none">RiskGuard</span>
                    <span className="text-[9px] text-slate-500 font-medium mt-0.5">by Telefónica</span>
                </div>
        ...
        {isWorkspaceMenuOpen && (
          <div ref={menuRef} className="absolute top-16 left-2 w-56 bg-white border border-slate-200 rounded-lg shadow-modal z-50 py-1 animate-enter origin-top-left">
            <div className="px-3 py-2 border-b border-slate-100">
              ...
              <p className="text-[13px] font-medium text-slate-900 mt-0.5">RiskGuard</p>
            </div>
            <div className="py-1">
              <button 
        ...
        <div className="mt-auto border-t border-slate-200">
            ...
            <div className="px-4 py-3 bg-slate-50/50 border-b border-slate-100">
                 <div className="flex items-center gap-2 opacity-70 hover:opacity-100 transition-opacity">
                    ...
                    <span className="text-[10px] font-bold text-slate-500 uppercase tracking-wider">Telefónica</span>
                 </div>
            </div>
